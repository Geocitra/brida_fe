 ...
 * Menyajikan visi digitalisasi riset BRIDA Kabupaten Mimika tanpa nested boxes (tanpa card tumpuk).
    ...
    return (
        <div className="flex flex-col h-full bg-white pb-12 animate-in fade-in slide-in-from-left-4 duration-500 overflow-y-auto custom-scrollbar text-slate-800">
            ...
            <div className="flex flex-col items-center text-center py-6 px-4 bg-slate-50 border-b border-slate-200 select-none">
                ...
                <div className="relative w-20 h-20 bg-transparent flex items-center justify-center mb-2.5">
                    <img
                        src="/logo-mimika.png"
                        alt="Logo Pemerintah Kabupaten Mimika"
                ...
                <div className="flex flex-col bg-white">
                    <div className="px-4 py-4 border-b border-slate-200 text-left">
                        <p className="text-[11px] text-slate-600 font-medium leading-relaxed text-justify">
                            Seluruh data spasial, metadata, dan dokumen laporan daerah dikelola secara mandiri oleh Badan Riset dan Inovasi Daerah (BRIDA) sebagai produsen data kognitif Kabupaten Mimika.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 divide-x divide-y divide-slate-200 border-b border-slate-200 bg-slate-50/50 select-none">
                        {[
                            { name: "BRIDA Mimika", icon: Cpu },
                            { name: "Bappeda Mimika", icon: Building2 },
                            { name: "BPS Kabupaten Mimika", icon: Globe },
                            { name: "Sekretariat Daerah", icon: Users }
                        ].map((opd, i) => (
            ...
            <div className="flex flex-col mt-4 border-t border-slate-200">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-[10px] text-slate-500 font-medium leading-relaxed">
                                Dibangun secara mandiri oleh tim analis sistem BRIDA Mimika menggunakan tumpukan teknologi modern Next-generation React Klien dan Leaflet Engine.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-4 py-6 bg-white select-none">
                    <p className="text-[9px] text-slate-400 font-black uppercase tracking-widest text-center leading-relaxed">
                        © 2026 Badan Riset dan Inovasi Daerah <br /> Pemerintah Kabupaten Mimika.
                    </p>
                </div>
            </div>
