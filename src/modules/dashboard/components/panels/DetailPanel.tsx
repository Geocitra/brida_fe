        ...
        <div className="flex flex-col w-full h-full bg-white relative text-slate-800">
            ...
            {activeTab === "analisis" && (
                <div className="flex flex-col pb-6 bg-white animate-in fade-in duration-200">
                    ...
                    <div className="border-t border-slate-200 pt-5 px-4 flex flex-col text-left">
                        ...
                        <p className="text-[10px] text-slate-500 mb-4 font-normal leading-relaxed">
                        ...
                        <div className="bg-white border-b border-t border-slate-200 p-3 mb-4 rounded-none -mx-4">
                            <div className="flex w-full items-center justify-between">
                                <label className="text-[13px] font-normal text-slate-700 uppercase cursor-pointer select-none" htmlFor="compareToggle">
                            ...
                            {isCompareMode && (
                                <div className="mt-3 flex flex-col gap-1.5 animate-in slide-in-from-top-2 duration-150">
                ...
                "
                        ...
                        {/* CHAT DISPLAY */}
                        {aiResponse && (
                            <div className="border border-slate-300 p-3 bg-slate-50/50 mb-4 max-h-55 overflow-y-auto custom-scrollbar select-text text-left">
                                ...
                                <div className="text-[11px] leading-relaxed text-slate-700">
                                    <RichMessageRenderer text={aiResponse} />
                                </div>
                            </div>
                        )}

                        {/* INPUT & ACTION BAR WITH CONTEXT BADGE */}
                        <form onSubmit={handleAiSubmit} className="flex flex-col gap-2 bg-slate-50 border border-slate-200 p-2 rounded-none">
